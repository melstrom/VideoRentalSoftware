...
public class CustomerInfoDialog extends javax.swing.JDialog {
    ...
    public CustomerInfoDialog(int panelType,boolean modal) {
        ...
        /** Creates new form CustomerInfoDialog */
    public CustomerInfoDialog(String customerID, int panelType,boolean modal) {
        this.panelType = panelType;
        this.customerID = customerID;
        initComponents();
        populateFields(this.customerID);
    }
    ...
    private void populateFields(String customerID){
        try {
            ...
            empIDCustomerTextField.setText("" + currentCustomer.getCustomerID());
            Address address = currentCustomer.getAddress();
            houseNumberCustomerTextField.setText("" + address.getHouseNumber());
            streetNameCustomerTextField.setText(address.getStreetName());
            cityCustomerTextField.setText(address.getCity());
            provinceCustomerTextField.setText(address.getProvince());
            countryCustomerTextField.setText(address.getCountry());
            postalCodeCustomerTextField.setText(address.getPostalCode());
    ...
    private void addToDatabase() throws SQLException, ClassNotFoundException, Exception{
        ...
        String DL = DLCustInfoTextField.getText();
        ...
        if (fname.equals("") || lname.equals("") || phoneNum.equals("") ||
            ...
            int customerID;
            if (empIDCustomerTextField.getText().equals(""))
                customerID = populateData.generateNewID("customer");
            else customerID = Integer.parseInt(empIDCustomerTextField.getText());
            ...
            if (panelType == 1){
                ...
                enteredIntoDatabaseLabel1.setText("CUSTOMER HAS BEEN UPDATED");
                currentCustomer = new Customer(DL, customerID, fname, lname, customerAddress, phoneNum);
            }
            enteredIntoDatabaseLabel1.setVisible(true);
        }
    }
